                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                     ...
                     {!! Form::open(['url'=>'admin/update-category','method'=>'POST','class'=>'form-horizontal form-label-left','name'=>'editForm']) !!}    
                        <!-- Category name -->
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" value="{{$categoryById ->category_name}}" name="catName" class="form-control col-md-7 col-xs-12">
                                <input type="hidden" value="{{$categoryById ->category_id}}" name="catId" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea class='form-control' name='catDes' row='8'>{{$categoryById ->category_description}}</textarea>
