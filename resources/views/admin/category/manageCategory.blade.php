          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Manage <small>Blog Category</small></h3>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>All <small>Blog Category</small></h2>
                     ...
                     <td>
                         ...
                         <?php
                            if( $category ->publicationStatus == 1){ ?>
                              <a href="{{url('admin/unpublished-category/'.$category ->category_id)}}" class="btn btn-warning">
                             <span class="glyphicon glyphicon-arrow-down"></span> Unpublished 
                         </a> 
                          <?php      }  else{ ?>
                           <a href="{{url('admin/published-category/'.$category ->category_id)}}" class="btn btn-info">
                         ...
                         <a href="{{url('admin/delete-category/'.$category ->category_id)}}" class="btn btn-danger">
